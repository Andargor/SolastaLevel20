...
namespace SolastaLevel20.Rules.Features
{
    public static class AttributeModifierFighterIndomitable3
    {
        ...
        public static void Load()
        {
            ...
            AccessTools.Field(attributeModifierFighterIndomitable3.GetType(), "modifierValue").SetValue(attributeModifierFighterIndomitable3, 3);

            DatabaseRepository.GetDatabase<FeatureDefinitionAttributeModifier>().Add(attributeModifierFighterIndomitable3);
        }
    }
}